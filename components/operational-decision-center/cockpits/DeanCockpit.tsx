...
import { 
  getHourlyVisitsData, PARETO_DATA, FINANCIAL_PIE_DATA, 
  ADMISSION_TREND_DATA, getScatterData, OUTPATIENT_MODAL_DATA 
} from '../../../src/data/deanData';
...
// Generate data once
const hourlyVisitsData = getHourlyVisitsData();
const paretoData = PARETO_DATA;
const financialPieData = FINANCIAL_PIE_DATA;
const admissionTrendData = ADMISSION_TREND_DATA;
const scatterData = getScatterData();
const outpatientModalData = OUTPATIENT_MODAL_DATA;
